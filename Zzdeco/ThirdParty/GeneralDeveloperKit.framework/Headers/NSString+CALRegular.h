//
//  NSString+CALRegular.h
//  CALRegularExpressions
//
//  Created by luojiahui on 16/3/9.
//  Copyright © 2016年 Cain. All rights reserved.
//

#import <Foundation/Foundation.h>

@interface NSString (CALRegular)
...
/*!
 *  @brief  当前字符长度是否位 length, 并且是由字母和数字所组成
 *  @param  length 字符的长度
 *  @param  string 字符的内容
 */
